...
const masterDealerOptions = [
  ...
  "Mediatouch Computer",
  "PT. IT SOLUSINDO - Pontianak",
  "PT Columbindo Citra Indah - Jakarta",
  "Enter Komputer",
  "Podomoro Notebook",
  "El's Computer",
  "CV. Alvatech - Makassar",
  "PT. Tri Inovasi",
  ...
  "BITRACOM INFORMATIKA",
  "Smart Media Computer",
  "PT. Utama Jaya Komputer",
  "PT. KRISTAL KOMPUTERINDO PERKASA",
  "Dewa Computer (Giant Komputer) / PT. MAHADEWA TEKNOLOGI KOMPUTINDO",
  "CV.  Annisa Computer / Anandam Computer / PT. SUPER GAMING INDONESIA",
  "CV. DATA BASIS TECHNOLOGY (Database Computer)",
  "Kometindo Komputama",
  "ARINGO COMPUTER - SAMARINDA",
  "CV MASTERPIECE / MASTER PIECE.com - SAMARINDA",
  "PT. Bintang Timor Sukses Sejahtera",
  "INFO COMPUTER CENTRE - BANJARMASIN",
  "CIPTA SARANA INTEGRASI, PT / CIPTA SARANA KOMPUTER",
  "Comcow Computer",
  "CV. KANA - Yogya",
  "TWINCOM - banjarbaru",
  "Matrix Computer - Bali",
  "Mugen Multi Distribusi, PT (Makasar)",
  "CV. Hypercom - Batam",
  "CV. FULUSO COMPUTER",
  ...
  "Digital Niaga Borneo, PT / PT. Hartora (Digital Niaga Borneo, PT)",
  "CV Cipta Jaya",
  "PT Masterdata Bali",
  "PT Surya Sen Indo",
  "Sg Computer",
  ...
  "Infotech Computer System (ICS) - Polewali Mandar",
  "NUANSA DHARMA CIPTA (NDC) - SAMARINDA",
  "Aneka Komputer - Banjarmasin",
  "Duta Sarana Computindo, CV",
  "SUKA GUNA INDONESIA",
  "METRO ELECTRONIC - BERAU",
  "HND Gemilang Solusindo, PT",
  "Pilar Global Solusi, PT",
  "Data Teknologi Solusindo, PT",
  "Trimitra Sukses Indonesia, PT",
  "VISINIAGA MITRA KREASINDO, PT",
  "My Icon Technology, PT",
  "Centraltech Global Solusi, PT",
  "Artha Infotama, PT",
  "Erakomp Infonusa, PT",
  "Multipro Jaya Prima (SMB)",
  "EIKON Technology, PT",
  "Panca Putra Solusindo",
  "Kahar Duta Sarana ",
  "Surya Artha Inovasi",
  "Primatech Computama Informatindo, PT",
  "Berca Hardayaperkasa, PT",
  "Platindo Karya Prima",
  "Perkom Indah Murni, PT",
  "PINS Indonesia, PT",
  "Artha Mulia Trijaya, PT",
  "Mitra Integrasi Informatika, PT",
  "Mitra Integrasi Solusi, PT",
  "Hipernet Indodata, PT",
  "Alpha Cipta Computindo, PT",
  "Mastersystem Infotama, PT",
  "Turbo Mitra Perkasa, PT",
  "Karlin Mastrindo, PT",
  "Intikom Berlian Mustika, PT",
  "Mitra Infosarana, PT",
  "Astra Graphia Information Technology",
  "Mega Akses Persada, PT",
  "Rentalworks Indonesia, PT",
  "Cipta Informatika Mandiri, PT",
  "Harya Pilar Utama Sukses, PT",
  "Griya Mitra Persada, PT",
  "Nusantara Compnet Integrator",
  "Infoduta Computindo Perkasa",
  "Javas Karya Tungga, PT",
  "Wirapandu Sukses Makmur, PT",
  "Global Giga Solusi, PT",
  "Multipolar Technology, PT",
  "Bhakti Solusindo, PT",
  "Global Digital Niaga, PT",
  "Sentral Mitra Informatika, PT",
  "PT. ASABA DIGITAL INNOTECH",
  "Bismacindo Perkasa, PT",
  "CLARUS INNOVACE TEKNOLOGI, PT",
  "MICROREKSA INFONET, PT",
  "Macro Trend Technology, PT",
  "PT. GLOBAL DISTRIBUSI NUSANTARA",
  "Global Harapan Nawasena, PT",
  "KARYA ANUGRAH TEKNOLOGI, PT.",
  "Revo Solusindo",
  "Lintas Virtual Global, PT",
  "Mitra Teleinformatika Perkasa, PT",
  "Micronics Internusa, PT",
  "Kirana Sakti Komputindo, PT",
  "Bhinneka Mentari Dimensi, PT",
  "Password Solusi Sistem, PT",
  "Maha Data Solusi, PT",
  "Multi Reksa Sinergitas, PT",
  "Techindo Solusi Cemerlang, PT",
  "Metrolink Kompudata, PT",
  "Kharisma Makmur Jaya, PT",
  "Sapta Tunas Teknologi, PT",
  "Mitra Solusi Infokom, PT",
  "Baliyoni Saguna, PT",
  "Hallo Indonesia Teknologi, PT",
  "HND Gemilang Solusindo, PT",
  "Central Plotter Indonesia, PT",
  "Tekno Iinti Optima, PT",
  "Generasi Mandiri Teknologi, PT",
  "Solusi Arya Prima, CV",
  "Anugrah Pratama, CV",
  "Brothersindo Saudara Emas, PT",
  "Digital Media Kreasindo, PT",
  "Dua Kawan Sejahtera Indonesia, PT",
  "Shasta Adhijaya, PT",
  "Performa Optima Group",
  "Sentra Kriya Edukasi, PT",
  "Solid Sapta Group",
  "Haiga Citra Digital, PT",
  "Pantero Selaras Agung, PT",
  "Mitra Sistematika Global, PT",
  "Air Mas Perkasa, PT",
  "Airmas Mataram Internusa, PT",
  "Alpha Graha Computindo, PT",
  "Duta Teknologi Nusantara, PT",
  "Daya Karya Hutama, PT",
  "Access Lintas Solusi, PT",
  "Zoom Infotek Telesindo, PT",
  "Trikreasindo Mandiri Sentosa, PT",
  "Samafitro, PT",
  "Spakat Teknologi Nusantara, PT",
  "Indonesia Comnet Plus, PT",
  "Bintang Utama Teknologi, PT ",
  "Pajajaran Informatika Nusantara, PT",
  "Putri Indah Informatika Solusi, PT",
];
